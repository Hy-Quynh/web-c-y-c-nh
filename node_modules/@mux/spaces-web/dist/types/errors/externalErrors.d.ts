 ...
 * to a Space that doesn't involve the JWT
 */
...
/**
 * PublishTrackError is thrown when there is an error publishing [[LocalTrack]] to a space
 */
export declare class PublishTrackError extends MuxError {
}
/**
 * UnpublishTrackError is thrown when there is an error unpublishing [[LocalTrack]] to a space
 */
export declare class UnpublishTrackError extends MuxError {
}
/**
 * UpdateTrackError is thrown when there is an error updating [[LocalTrack]] in a space
 */
