    ...
    <div className="container-xxl py-6">
      <div className="container">
        ...
        >
          ...
          <div style={{ width: "50%" }}>
            <div style={{ fontWeight: 700, fontSize: "18px" }}>Hoá đơn mẫu</div>
            <div
              style={{ width: "100%", height: "400px", position: "relative" }}
            >
              <Image
                src="/img/hoa-don-dien.png"
                alt="Hoá đơn mẫu"
                layout="fill"
              />
            </div>
...
const PaymentCardModal = (props) => {
  ...
  const handleElectricityPayment = async () => {
    ...
    const { error, paymentMethod } = await stripe.createPaymentMethod({
      ...
      billing_details: {
        email: "thanhtoanhoadondien@gmail.com",
        phone: customerPhone,
        name: customerName,
      },
    });
    ...
    if (!error) {
      ...
      try {
        ...
        const paymentRes = await electricityPayment(paymentData);
  ...
  return (
    <CustomDialog
      ...
      handleSubmit={() => handleElectricityPayment()}
      maxWidth="800px"
      width="800px"
    >
      <div className={style.electricityModal}>
        ...
        <div className="modal-info">
          <div className="info-title">Mã khách hàng</div>
